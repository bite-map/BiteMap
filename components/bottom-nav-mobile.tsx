...
//     <button
//       onClick={toggleSidebar}
//       className="fixed top-4 left-4 text-3x1 text-gray-700 md:hidden"
//     >
//       &#9776; {/* hamburger icon */}
//     </button>
//   </>
...
//       <button
//         onClick={toggleSidebar}
//         className="fixed top-4 left-4 text-3xl text-gray-700 md:hidden"
//       >
//         &#9776; {/* Hamburger icon */}
//       </button>
...
//         }`}
//       >
//         {/* Button for each item passed to the component */}
//         {NavButtons.map((NavButton, index) => (
//           <NavButtonMobile key={index} NavButton={NavButton} />
//         ))}
//       </div>
