...
export default function PrivacyPolicyPage() {
  return (
    <div className="p-6">
      ...
      <p>
        Effective Date: <span className="italic font-semibold">2025-03-24</span>
      </p>
      <p>
      ...
      <ul className="list-disc pl-8">
        <li>
          Provide location-based services and recommend nearby food trucks.
        </li>
      ...
      <p>
        We do not sell your information. However, we may share it in the
        following cases:
      </p>
      <ul className="list-disc pl-8">
      ...
      <p>
        ...
        at <span className="italic font-semibold">cc.bitemap@gmail.com</span>
      </p>
    </div>
  );
}
